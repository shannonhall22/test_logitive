class CostStructuresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cost_structure.save
        ...
        format.json { render :show, status: :created, location: @cost_structure }
      else
  ...
  def update
    respond_to do |format|
      if @cost_structure.update(cost_structure_params)
        ...
        format.json { render :show, status: :ok, location: @cost_structure }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cost_structures_url, notice: 'Cost structure was successfully destroyed.' }
  ...
  private
    ...
    def cost_structure_params
      params.require(:cost_structure).permit(:name)
    end
end
